...
Implemented as a thin adapter over the OpenAI-compat shim when the
configured `GEMINI_BASE_URL` is OpenAI-shaped; otherwise it raises so the
operator can either set the OpenAI-compat endpoint or wire the official
SDK in this module.
"""
